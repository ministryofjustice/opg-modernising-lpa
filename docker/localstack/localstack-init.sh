...
cat > lambda-env.json <<EOF
{
  ...
  "ATTORNEY_START_URL": "$ATTORNEY_START_URL",
  "AWS_ACCESS_KEY_ID": "$AWS_ACCESS_KEY_ID",
  "AWS_BASE_URL": "$AWS_BASE_URL",
  "AWS_REGION": "$AWS_REGION",
  "AWS_SECRET_ACCESS_KEY": "$AWS_SECRET_ACCESS_KEY",
  "CERTIFICATE_PROVIDER_START_URL": "$CERTIFICATE_PROVIDER_START_URL",
  "DATA_DIR": "$DATA_DIR",
  "DEBUG": "$DEBUG",
  "DOCKER_HOST": "$DOCKER_HOST",
  "DONOR_START_URL": "$DONOR_START_URL",
  "EVENT_BUS_NAME": "$EVENT_BUS_NAME",
  "GOVUK_NOTIFY_BASE_URL": "$GOVUK_NOTIFY_BASE_URL",
  "LPA_STORE_BASE_URL": "$LPA_STORE_BASE_URL",
  "LPA_STORE_SECRET_ARN": "$LPA_STORE_SECRET_ARN",
  "LPAS_TABLE": "$LPAS_TABLE",
  "METRICS_ENABLED": "$METRICS_ENABLED",
  "OPENSEARCH_CUSTOM_BACKEND": "$OPENSEARCH_CUSTOM_BACKEND",
  "S3_UPLOADS_KMS_KEY_ALIAS": "$S3_UPLOADS_KMS_KEY_ALIAS",
  "SEARCH_ENDPOINT": "$SEARCH_ENDPOINT",
  "SEARCH_INDEXING_DISABLED": "$SEARCH_INDEXING_DISABLED",
  "SEARCH_INDEX_NAME": "$SEARCH_INDEX_NAME",
  "SERVICES": "$SERVICES",
  "TAG": "$TAG",
  "UID_BASE_URL": "$UID_BASE_URL",
  "UPLOAD_S3_BUCKET": "$UPLOAD_S3_BUCKET",
  "UPLOADS_S3_BUCKET_NAME": "$UPLOAD_S3_BUCKET",
