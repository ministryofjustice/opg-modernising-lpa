...
func run(ctx context.Context, logger *slog.Logger) error {
	var (
		...
		donorStartURL               = appPublicURL + os.Getenv("DONOR_START_URL")
		certificateProviderStartURL = appPublicURL + os.Getenv("CERTIFICATE_PROVIDER_START_URL")
		attorneyStartURL            = appPublicURL + os.Getenv("ATTORNEY_START_URL")
