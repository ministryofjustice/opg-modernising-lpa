...
func TestHandleFeeApproved(t *testing.T) {
	...
	shareCodeSender.
		On("SendCertificateProvider", ctx, false, page.AppData{}, &actor.DonorProvidedDetails{PK: "LPA#123", SK: "#DONOR#456", Tasks: actor.DonorTasks{PayForLpa: actor.PaymentTaskCompleted}, UpdatedAt: now}).
		Return(nil)
