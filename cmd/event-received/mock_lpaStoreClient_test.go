...
func (_m *mockLpaStoreClient) SendLpa(ctx context.Context, donor *donordata.DonorProvidedDetails) error {
...
func (_c *mockLpaStoreClient_SendLpa_Call) Run(run func(ctx context.Context, donor *donordata.DonorProvidedDetails)) *mockLpaStoreClient_SendLpa_Call {
	_c.Call.Run(func(args mock.Arguments) {
