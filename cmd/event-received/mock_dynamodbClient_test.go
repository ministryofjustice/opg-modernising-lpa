...
func (_m *mockDynamodbClient) UpdateReturn(ctx context.Context, pk dynamo.PK, sk dynamo.SK, values map[string]types.AttributeValue, expression string) (map[string]types.AttributeValue, error) {
...
func (_c *mockDynamodbClient_UpdateReturn_Call) Run(run func(ctx context.Context, pk dynamo.PK, sk dynamo.SK, values map[string]types.AttributeValue, expression string)) *mockDynamodbClient_UpdateReturn_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *mockDynamodbClient_UpdateReturn_Call) RunAndReturn(run func(context.Context, dynamo.PK, dynamo.SK, map[string]types.AttributeValue, string) (map[string]types.AttributeValue, error)) *mockDynamodbClient_UpdateReturn_Call {
	_c.Call.Return(run)
	return _c
}
