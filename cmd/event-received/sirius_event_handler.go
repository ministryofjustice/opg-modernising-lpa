...
func (h *siriusEventHandler) Handle(ctx context.Context, factory factory, cloudWatchEvent *events.CloudWatchEvent) error {
	...
	case "immaterial-change-confirmed":
		...
		return handleChangeConfirmed(ctx, factory.DynamoClient(), cloudWatchEvent, factory.Now(), lpaStoreClient, false)
	...
	case "material-change-confirmed":
		...
		return handleChangeConfirmed(ctx, factory.DynamoClient(), cloudWatchEvent, factory.Now(), lpaStoreClient, true)
...
func handleChangeConfirmed(ctx context.Context, client dynamodbClient, event *events.CloudWatchEvent, now func() time.Time, lpaStoreClient LpaStoreClient, materialChange bool) error {
