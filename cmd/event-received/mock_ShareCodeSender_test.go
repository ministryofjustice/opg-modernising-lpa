...
// SendOnlineCertificateProviderPrompt provides a mock function with given fields: ctx, appData, provided, lpa
func (_m *mockShareCodeSender) SendOnlineCertificateProviderPrompt(ctx context.Context, appData appcontext.Data, provided *donordata.Provided, lpa *lpadata.Lpa) error {
	ret := _m.Called(ctx, appData, provided, lpa)

	if len(ret) == 0 {
		panic("no return value specified for SendOnlineCertificateProviderPrompt")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, appcontext.Data, *donordata.Provided, *lpadata.Lpa) error); ok {
		r0 = rf(ctx, appData, provided, lpa)
	} else {
		r0 = ret.Error(0)
	}
...
// mockShareCodeSender_SendOnlineCertificateProviderPrompt_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SendOnlineCertificateProviderPrompt'
type mockShareCodeSender_SendOnlineCertificateProviderPrompt_Call struct {
	*mock.Call
}

// SendOnlineCertificateProviderPrompt is a helper method to define mock.On call
//   - ctx context.Context
//   - appData appcontext.Data
//   - provided *donordata.Provided
//   - lpa *lpadata.Lpa
func (_e *mockShareCodeSender_Expecter) SendOnlineCertificateProviderPrompt(ctx interface{}, appData interface{}, provided interface{}, lpa interface{}) *mockShareCodeSender_SendOnlineCertificateProviderPrompt_Call {
	return &mockShareCodeSender_SendOnlineCertificateProviderPrompt_Call{Call: _e.mock.On("SendOnlineCertificateProviderPrompt", ctx, appData, provided, lpa)}
}

func (_c *mockShareCodeSender_SendOnlineCertificateProviderPrompt_Call) Run(run func(ctx context.Context, appData appcontext.Data, provided *donordata.Provided, lpa *lpadata.Lpa)) *mockShareCodeSender_SendOnlineCertificateProviderPrompt_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(appcontext.Data), args[2].(*donordata.Provided), args[3].(*lpadata.Lpa))
	})
	return _c
}

func (_c *mockShareCodeSender_SendOnlineCertificateProviderPrompt_Call) Return(_a0 error) *mockShareCodeSender_SendOnlineCertificateProviderPrompt_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *mockShareCodeSender_SendOnlineCertificateProviderPrompt_Call) RunAndReturn(run func(context.Context, appcontext.Data, *donordata.Provided, *lpadata.Lpa) error) *mockShareCodeSender_SendOnlineCertificateProviderPrompt_Call {
	_c.Call.Return(run)
	return _c
}
