...
describe('Smoke tests', () => {
  ...
  describe('app', () => {
      it('is available', { requestTimeout: 30000, defaultCommandTimeout: 20000 }, () => {
      cy.visit('/')
      ...
      if (Cypress.config().baseUrl.includes('1221mlpab18')) {
        ...
        cy.origin('https://demo.app.modernising.opg.service.justice.gov.uk', () => {
          cy.url().should('contain', '/auth/redirect');
        });
