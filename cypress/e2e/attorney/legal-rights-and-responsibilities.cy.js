describe('Legal rights and responsibilities', () => {
    it('can continue to next page', () => {
        cy.visit('/testing-start?redirect=/attorney-legal-rights-and-responsibilities&completeLpa=1&withAttorneys=1&signedByDonor=1&asAttorney=1&loginAs=attorney');
