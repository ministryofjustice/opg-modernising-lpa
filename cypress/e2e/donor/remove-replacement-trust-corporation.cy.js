describe('Remove trust corporation', () => {
  beforeEach(() => {
    cy.visit('/fixtures?redirect=/choose-replacement-attorneys-summary&progress=chooseYourReplacementAttorneys&replacementAttorneys=trust-corporation');
  });

  it('can be removed', () => {
    cy.contains('You have added 3 replacement attorneys');
