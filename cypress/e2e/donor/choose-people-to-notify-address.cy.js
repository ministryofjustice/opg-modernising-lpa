...
describe('People to notify address', () => {
    describe('Entering a new address', () => {
        beforeEach(() => {
            cy.visit('/testing-start?lpa.peopleToNotify=-1&redirect=/choose-people-to-notify-address?id=JoannaSmith');
    ...
    it('address can be copied from another actor', () => {
        cy.visit('/testing-start?redirect=/choose-people-to-notify-address?id=JoannaSmith&lpa.peopleToNotify=-1&lpa.certificateProvider=1');
