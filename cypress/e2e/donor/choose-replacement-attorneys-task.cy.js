...
describe('Choose replacement attorneys task', () => {
    ...
    it('is in progress if enter a replacement attorneys details then add attorneys', () => {
        ...
        cy.get('#f-first-names').invoke('val', 'Janet');
        cy.get('#f-last-name').invoke('val', 'Doe');
        cy.get('#f-email').invoke('val', TestEmail);
        cy.get('#f-date-of-birth').invoke('val', '1');
        cy.get('#f-date-of-birth-month').invoke('val', '2');
    ...
    describe('having a single attorney and multiple replacement attorneys', () => {
        ...
        it('is completed if replacement act mixed', () => {
            ...
            cy.get('textarea').invoke('val', 'Some details');
            cy.contains('button', 'Save and continue').click();
    ...
    describe('having jointly and severally attorneys and a single replacement attorney', () => {
        ...
        it('is completed if step in when all', () => {
            cy.contains('label', 'All together, when all').click();
            cy.contains('button', 'Save and continue').click();
        ...
        it('is completed if step in some other way', () => {
            cy.contains('label', 'In a particular way or order').click();
            cy.get('textarea').invoke('val', 'Details');
            cy.contains('button', 'Save and continue').click();
    ...
    describe('having jointly and severally attorneys and multiple replacement attorneys', () => {
        ...
        it('is in progress if step in when all', () => {
            cy.contains('label', 'All together, when all').click();
            cy.contains('button', 'Save and continue').click();
        ...
        it('is completed if step in when all and jointly and severally', () => {
            cy.contains('label', 'All together, when all').click();
            cy.contains('button', 'Save and continue').click();
        ...
        it('is completed if step in when all and jointly', () => {
            cy.contains('label', 'All together, when all').click();
            cy.contains('button', 'Save and continue').click();
        ...
        it('is completed if step in when all and mixed', () => {
            cy.contains('label', 'All together, when all').click();
            cy.contains('button', 'Save and continue').click();
