...
func TestingStart(store sesh.Store, lpaStore LpaStore, randomString func(int) string) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		_ = sesh.SetDonorSession(store, r, w, &sesh.DonorSession{Sub: sub, Email: "simulate-delivered@notifications.service.gov.uk"})
		...
		if r.FormValue("asCertificateProvider") == "1" {
			_ = sesh.SetCertificateProviderSession(store, r, w, &sesh.CertificateProviderSession{
				Sub:            randomString(12),
