...
func TestingStart(store sesh.Store, lpaStore LpaStore, randomString func(int) string, dataStore DataStore, shareCodeSender *ShareCodeSender) http.HandlerFunc {
