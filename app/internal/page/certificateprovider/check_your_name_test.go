...
func TestGetEnterYourName(t *testing.T) {
	...
	certificateProviderStore.
		On("Get", r.Context()).
		Return(page.CertificateProviderDetails{}, nil)
...
func TestGetEnterYourNameOnCertificateProviderStoreError(t *testing.T) {
	...
	certificateProviderStore.
		On("Get", r.Context()).
		Return(page.CertificateProviderDetails{}, expectedError)
...
func TestPostEnterYourName(t *testing.T) {
	...
	certificateProviderStore.
		On("Put", r.Context(), page.CertificateProviderDetails{FirstNames: "Bob", LastName: "Smith"}).
		Return(nil)
