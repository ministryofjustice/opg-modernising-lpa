...
func TestGetChooseReplacementAttorneysAddress(t *testing.T) {
	...
	lpaStore.
		On("Get", r.Context()).
		Return(&Lpa{ReplacementAttorneys: actor.Attorneys{ra}}, nil)
...
func TestPostChooseReplacementAttorneysAddressManualWhenStoreErrors(t *testing.T) {
	...
	lpaStore.
		On("Get", r.Context()).
		Return(&Lpa{ReplacementAttorneys: actor.Attorneys{{ID: "123"}}}, nil)
...
func TestPostChooseReplacementAttorneysAddressSelect(t *testing.T) {
	...
	lpaStore.
		On("Put", r.Context(), &Lpa{ReplacementAttorneys: actor.Attorneys{updatedRa}}).
		Return(nil)
