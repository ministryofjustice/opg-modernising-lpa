...
type lifeSustainingTreatmentOptions struct {
	OptionA page.LifeSustainingTreatmentOption
	OptionB page.LifeSustainingTreatmentOption
}
...
type lifeSustainingTreatmentForm struct {
	Option page.LifeSustainingTreatmentOption
	Error  error
}

func readLifeSustainingTreatmentForm(r *http.Request) *lifeSustainingTreatmentForm {
	option, err := page.ParseLifeSustainingTreatmentOption(page.PostFormString(r, "option"))
