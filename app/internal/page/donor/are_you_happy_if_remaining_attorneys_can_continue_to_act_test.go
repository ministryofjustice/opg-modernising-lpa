...
func TestGetAreYouHappyIfRemainingAttorneysCanContinueToAct(t *testing.T) {
	...
	err := AreYouHappyIfRemainingAttorneysCanContinueToAct(template.Execute, lpaStore)(testAppData, w, r)
	resp := w.Result()
...
func TestGetAreYouHappyIfRemainingAttorneysCanContinueToActWhenStoreErrors(t *testing.T) {
	...
	err := AreYouHappyIfRemainingAttorneysCanContinueToAct(nil, lpaStore)(testAppData, w, r)
	resp := w.Result()
		...
		t.Run(happy, func(t *testing.T) {
			...
			lpaStore.
				On("Put", r.Context(), &page.Lpa{
					HowAttorneysMakeDecisions: actor.AttorneyDecisions{HappyIfRemainingCanContinueToAct: happy},
