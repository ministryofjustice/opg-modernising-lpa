...
func TestGetHowWouldCertificateProviderPreferToCarryOutTheirRole(t *testing.T) {
	...
	err := HowWouldCertificateProviderPreferToCarryOutTheirRole(template.Func, lpaStore)(page.TestAppData, w, r)
	resp := w.Result()
...
func TestGetHowWouldCertificateProviderPreferToCarryOutTheirRoleWhenStoreErrors(t *testing.T) {
	...
	err := HowWouldCertificateProviderPreferToCarryOutTheirRole(nil, lpaStore)(page.TestAppData, w, r)
	resp := w.Result()
