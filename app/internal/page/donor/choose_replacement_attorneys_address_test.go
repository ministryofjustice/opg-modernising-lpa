...
func TestGetChooseReplacementAttorneysAddress(t *testing.T) {
	...
	err := ChooseReplacementAttorneysAddress(nil, template.Execute, nil, nil)(testAppData, w, r, &page.Lpa{ReplacementAttorneys: actor.NewAttorneys(nil, []actor.Attorney{ra})})
	resp := w.Result()
...
func TestPostChooseReplacementAttorneysAddressSkip(t *testing.T) {
	...
	donorStore.
		On("Put", r.Context(), &page.Lpa{
			ID:                   "lpa-id",
			ReplacementAttorneys: actor.NewAttorneys(nil, []actor.Attorney{{ID: "123", FirstNames: "a", Email: "a"}}),
...
func TestPostChooseReplacementAttorneysAddressManual(t *testing.T) {
	...
	err := ChooseReplacementAttorneysAddress(nil, nil, nil, donorStore)(testAppData, w, r, &page.Lpa{
		ID:                   "lpa-id",
		ReplacementAttorneys: actor.NewAttorneys(nil, []actor.Attorney{{ID: "123", FirstNames: "a"}}),
	})
	resp := w.Result()
...
func TestPostChooseReplacementAttorneysAddressManualWhenStoreErrors(t *testing.T) {
	...
	err := ChooseReplacementAttorneysAddress(nil, nil, nil, donorStore)(testAppData, w, r, &page.Lpa{ReplacementAttorneys: actor.NewAttorneys(nil, []actor.Attorney{{ID: "123"}})})
...
func TestPostChooseReplacementAttorneysAddressManualWhenValidationError(t *testing.T) {
	...
	err := ChooseReplacementAttorneysAddress(nil, template.Execute, nil, nil)(testAppData, w, r, &page.Lpa{ReplacementAttorneys: actor.NewAttorneys(nil, []actor.Attorney{{ID: "123"}})})
	resp := w.Result()
...
func TestPostChooseReplacementAttorneysPostcodeSelectWhenValidationError(t *testing.T) {
	...
	err := ChooseReplacementAttorneysAddress(nil, template.Execute, addressClient, nil)(testAppData, w, r, &page.Lpa{ReplacementAttorneys: actor.NewAttorneys(nil, []actor.Attorney{{ID: "123"}})})
	resp := w.Result()
...
func TestPostChooseReplacementAttorneysPostcodeLookupError(t *testing.T) {
	...
	err := ChooseReplacementAttorneysAddress(logger, template.Execute, addressClient, nil)(testAppData, w, r, &page.Lpa{ReplacementAttorneys: actor.NewAttorneys(nil, []actor.Attorney{{ID: "123"}})})
	resp := w.Result()
...
func TestPostChooseReplacementAttorneysPostcodeLookupInvalidPostcodeError(t *testing.T) {
	...
	err := ChooseReplacementAttorneysAddress(logger, template.Execute, addressClient, nil)(testAppData, w, r, &page.Lpa{
		ReplacementAttorneys: actor.NewAttorneys(nil, []actor.Attorney{{ID: "123"}}),
	})
	resp := w.Result()
...
func TestPostChooseReplacementAttorneysAddressReuseSelect(t *testing.T) {
	...
	donorStore.
		On("Put", r.Context(), &page.Lpa{
			ID:                   "lpa-id",
			ReplacementAttorneys: actor.NewAttorneys(nil, []actor.Attorney{updatedAttorney}),
