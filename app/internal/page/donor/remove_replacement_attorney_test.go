...
func TestGetRemoveReplacementAttorney(t *testing.T) {
	...
	err := RemoveReplacementAttorney(logger, template.Execute, nil)(testAppData, w, r, &page.Lpa{ReplacementAttorneys: actor.NewAttorneys(nil, []actor.Attorney{attorney})})
...
func TestGetRemoveReplacementAttorneyAttorneyDoesNotExist(t *testing.T) {
	...
	err := RemoveReplacementAttorney(logger, template.Execute, nil)(testAppData, w, r, &page.Lpa{ID: "lpa-id", ReplacementAttorneys: actor.NewAttorneys(nil, []actor.Attorney{attorney})})
...
func TestPostRemoveReplacementAttorney(t *testing.T) {
	...
	testcases := map[string]struct {
		...
		"many left": {
			lpa: &page.Lpa{
				ID:                           "lpa-id",
				ReplacementAttorneys:         actor.NewAttorneys(nil, []actor.Attorney{attorneyWithEmail, attorneyWithAddress, attorneyWithoutAddress}),
				ReplacementAttorneyDecisions: actor.AttorneyDecisions{How: actor.Jointly},
			},
			updatedLpa: &page.Lpa{
				ID:                           "lpa-id",
				ReplacementAttorneys:         actor.NewAttorneys(nil, []actor.Attorney{attorneyWithEmail, attorneyWithAddress}),
				ReplacementAttorneyDecisions: actor.AttorneyDecisions{How: actor.Jointly},
		...
		"one left": {
			lpa: &page.Lpa{
				ID:                           "lpa-id",
				ReplacementAttorneys:         actor.NewAttorneys(nil, []actor.Attorney{attorneyWithAddress, attorneyWithoutAddress}),
				ReplacementAttorneyDecisions: actor.AttorneyDecisions{How: actor.Jointly},
			},
			updatedLpa: &page.Lpa{
				ID:                   "lpa-id",
				ReplacementAttorneys: actor.NewAttorneys(nil, []actor.Attorney{attorneyWithAddress}),
				Tasks:                page.Tasks{ChooseReplacementAttorneys: actor.TaskInProgress},
			},
			redirect: page.Paths.ChooseReplacementAttorneysSummary,
		},
		"none left": {
			lpa: &page.Lpa{ID: "lpa-id", ReplacementAttorneys: actor.NewAttorneys(nil, []actor.Attorney{attorneyWithoutAddress})},
			updatedLpa: &page.Lpa{
				ID:                   "lpa-id",
...
func TestPostRemoveReplacementAttorneyWithFormValueNo(t *testing.T) {
	...
	err := RemoveReplacementAttorney(logger, template.Execute, nil)(testAppData, w, r, &page.Lpa{ID: "lpa-id", ReplacementAttorneys: actor.NewAttorneys(nil, []actor.Attorney{attorneyWithoutAddress, attorneyWithAddress})})
...
func TestPostRemoveReplacementAttorneyErrorOnPutStore(t *testing.T) {
	...
	err := RemoveReplacementAttorney(logger, template.Execute, donorStore)(testAppData, w, r, &page.Lpa{
		...
		ReplacementAttorneys:     actor.NewAttorneys(nil, []actor.Attorney{attorneyWithoutAddress, attorneyWithAddress}),
	})
...
func TestRemoveReplacementAttorneyFormValidation(t *testing.T) {
	...
	err := RemoveReplacementAttorney(nil, template.Execute, nil)(testAppData, w, r, &page.Lpa{ReplacementAttorneys: actor.NewAttorneys(nil, []actor.Attorney{attorneyWithoutAddress})})
	resp := w.Result()
