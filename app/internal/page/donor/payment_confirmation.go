...
func PaymentConfirmation(logger Logger, tmpl template.Template, payClient PayClient, lpaStore LpaStore, sessionStore sessions.Store, shareCodeSender *page.ShareCodeSender) page.Handler {
