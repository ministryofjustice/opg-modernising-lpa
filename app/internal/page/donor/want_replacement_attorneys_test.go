...
func TestGetWantReplacementAttorneysWithExistingReplacementAttorneys(t *testing.T) {
	...
	err := WantReplacementAttorneys(template.Execute, nil)(testAppData, w, r, &page.Lpa{ID: "lpa-id", ReplacementAttorneys: actor.Attorneys{Attorneys: []actor.Attorney{{FirstNames: "this"}}}})
	resp := w.Result()
