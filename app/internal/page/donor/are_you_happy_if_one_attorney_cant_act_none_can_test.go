...
func TestPostAreYouHappyIfOneAttorneyCantActNoneCan(t *testing.T) {
	testcases := map[string]struct {
		...
		"yes": {
			lpa: &page.Lpa{
				HowAttorneysMakeDecisions: actor.AttorneyDecisions{HappyIfOneCannotActNoneCan: "yes"},
		...
		"no": {
			lpa: &page.Lpa{
				HowAttorneysMakeDecisions: actor.AttorneyDecisions{HappyIfOneCannotActNoneCan: "no"},
			},
