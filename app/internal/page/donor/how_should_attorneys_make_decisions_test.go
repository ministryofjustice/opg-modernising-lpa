...
func TestGetHowShouldAttorneysMakeDecisionsFromStore(t *testing.T) {
	...
	lpaStore.
		On("Get", r.Context()).
		Return(&page.Lpa{HowAttorneysMakeDecisions: actor.AttorneyDecisions{Details: "some decisions", How: "jointly"}}, nil)
	...
	template.
		On("Execute", w, &howShouldAttorneysMakeDecisionsData{
			...
			Lpa: &page.Lpa{HowAttorneysMakeDecisions: actor.AttorneyDecisions{Details: "some decisions", How: "jointly"}},
		}).
		Return(nil)
...
func TestPostHowShouldAttorneysMakeDecisions(t *testing.T) {
	...
	lpaStore.
		On("Get", r.Context()).
		Return(&page.Lpa{
			HowAttorneysMakeDecisions: actor.AttorneyDecisions{Details: "", How: ""},
		}, nil)
	lpaStore.
		On("Put", r.Context(), &page.Lpa{
			HowAttorneysMakeDecisions: actor.AttorneyDecisions{Details: "", How: "jointly"},
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			...
			lpaStore.
				On("Get", r.Context()).
				Return(&page.Lpa{
					HowAttorneysMakeDecisions: actor.AttorneyDecisions{Details: tc.existingDetails, How: tc.existingType},
				}, nil)
			lpaStore.
				On("Put", r.Context(), &page.Lpa{
					HowAttorneysMakeDecisions: actor.AttorneyDecisions{Details: tc.updatedDetails, How: tc.updatedType},
