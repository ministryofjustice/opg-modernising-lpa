...
func (_m *mockAttorneyStore) Create(_a0 context.Context, _a1 string, _a2 bool) (*actor.AttorneyProvidedDetails, error) {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 *actor.AttorneyProvidedDetails
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, bool) (*actor.AttorneyProvidedDetails, error)); ok {
		return rf(_a0, _a1, _a2)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, bool) *actor.AttorneyProvidedDetails); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
