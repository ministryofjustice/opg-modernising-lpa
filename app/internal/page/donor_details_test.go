...
func TestGetDonorDetails(t *testing.T) {
	...
	DonorDetails(nil, localizer, En, template.Func, dataStore)(w, withSession(r))
	resp := w.Result()
...
func TestGetDonorDetailsWhenTemplateErrors(t *testing.T) {
	...
	DonorDetails(logger, localizer, En, template.Func, dataStore)(w, withSession(r))
	resp := w.Result()
...
func TestPostDonorDetails(t *testing.T) {
	...
	DonorDetails(nil, localizer, En, nil, dataStore)(w, withSession(r))
	resp := w.Result()
