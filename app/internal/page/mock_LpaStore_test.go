...
func (_m *mockLpaStore) Create(_a0 context.Context) (*Lpa, error) {
	ret := _m.Called(_a0)
...
func (_m *mockLpaStore) Get(_a0 context.Context) (*Lpa, error) {
	ret := _m.Called(_a0)
...
func (_m *mockLpaStore) GetAll(_a0 context.Context) ([]*Lpa, error) {
	ret := _m.Called(_a0)
...
func (_m *mockLpaStore) Put(_a0 context.Context, _a1 *Lpa) error {
