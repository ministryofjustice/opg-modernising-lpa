...
type LifeSustainingTreatmentOption string

const (
	LifeSustainingTreatmentOptionA = LifeSustainingTreatmentOption("option-a")
	LifeSustainingTreatmentOptionB = LifeSustainingTreatmentOption("option-b")
)

func ParseLifeSustainingTreatmentOption(s string) (LifeSustainingTreatmentOption, error) {
	switch s {
	case "option-a":
	...
	default:
		return LifeSustainingTreatmentOption(""), fmt.Errorf("invalid LifeSustainingTreatmentOption '%s'", s)
	}
}

func (e LifeSustainingTreatmentOption) String() string {
	return string(e)
}
...
type Lpa struct {
	...
	LifeSustainingTreatmentOption LifeSustainingTreatmentOption
