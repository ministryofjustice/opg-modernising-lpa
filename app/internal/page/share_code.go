...
func (s *ShareCodeSender) sendAttorney(ctx context.Context, template notify.Template, appData AppData, lpa *Lpa, attorney actor.Attorney, isReplacement bool) error {
	if attorney.Email == "" {
		return nil
	}
...
func (s *ShareCodeSender) sendTrustCorporation(ctx context.Context, template notify.Template, appData AppData, lpa *Lpa, trustCorporation actor.TrustCorporation, isReplacement bool) error {
