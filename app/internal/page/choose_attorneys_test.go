...
func TestAttorneyMatches(t *testing.T) {
	...
	assert.Equal(t, "", attorneyMatches(lpa, "123", "x", "y"))
	assert.Equal(t, "errorDonorMatchesActor", attorneyMatches(lpa, "123", "a", "b"))
	assert.Equal(t, "errorAttorneyMatchesAttorney", attorneyMatches(lpa, "123", "c", "d"))
	assert.Equal(t, "", attorneyMatches(lpa, "123", "e", "f"))
	assert.Equal(t, "errorReplacementAttorneyMatchesActor", attorneyMatches(lpa, "123", "g", "h"))
	assert.Equal(t, "errorReplacementAttorneyMatchesActor", attorneyMatches(lpa, "123", "i", "j"))
	assert.Equal(t, "errorCertificateProviderMatchesActor", attorneyMatches(lpa, "123", "k", "l"))
	assert.Equal(t, "errorPersonToNotifyMatchesActor", attorneyMatches(lpa, "123", "m", "n"))
	assert.Equal(t, "errorPersonToNotifyMatchesActor", attorneyMatches(lpa, "123", "o", "p"))
}
