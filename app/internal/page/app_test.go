...
func TestMakeHandle(t *testing.T) {
	...
	handle("/path", true, func(appData AppData, hw http.ResponseWriter, hr *http.Request) {
...
func TestMakeHandleNoSessionRequired(t *testing.T) {
	...
	handle("/path", false, func(appData AppData, hw http.ResponseWriter, hr *http.Request) {
		assert.Equal(t, AppData{
			Page:             "/path",
			Localizer:        localizer,
			Lang:             En,
