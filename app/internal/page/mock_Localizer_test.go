...
// Possessive provides a mock function with given fields: s, lang
func (_m *mockLocalizer) Possessive(s string, lang localize.Lang) string {
	ret := _m.Called(s, lang)

	var r0 string
	if rf, ok := ret.Get(0).(func(string, localize.Lang) string); ok {
		r0 = rf(s, lang)
	} else {
		r0 = ret.Get(0).(string)
	}
