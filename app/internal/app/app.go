...
func App(
	...
	handleRoot := makeHandle(rootMux, logger, sessionStore, localizer, lang, rumConfig, staticHash)
	...
	return page.ValidateCsrf(rootMux, sessionStore, random.String)
}

func makeHandle(mux *http.ServeMux, logger Logger, store sesh.Store, localizer localize.Localizer, lang localize.Lang, rumConfig page.RumConfig, staticHash string) func(string, page.Handler) {
