...
output "iam_roles" {
  value = {
    ...
    create_s3_batch_replication_jobs_lambda = aws_iam_role.create_s3_batch_replication_jobs_lambda_role
    event_received_lambda_role              = aws_iam_role.event_received_lambda_role
  }
}
