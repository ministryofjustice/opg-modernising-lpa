  ...
  app = jsonencode(
    {
      ...
      environment = [
        ...
        {
          name  = "ISSUER",
          value = var.mock_onelogin_enabled ? "mock-onelogin.${data.aws_default_tags.current.tags.environment-name}.internal.modernising.ecs" : "https://oidc.integration.account.gov.uk"
        },
        {
