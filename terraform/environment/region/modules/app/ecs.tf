  ...
  app = jsonencode(
    {
      ...
      environment = [
        ...
        {
          name  = "IDENTITY_URL",
          value = var.mock_onelogin_enabled ? "http://mock-onelogin.${data.aws_default_tags.current.tags.environment-name}.internal.modernising.ecs:8080" : "https://identity.integration.account.gov.uk"
        },
        {
          name  = "APP_PUBLIC_URL",
