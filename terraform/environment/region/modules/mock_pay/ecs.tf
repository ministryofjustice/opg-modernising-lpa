...
locals {
  mock_pay_service_discovery_fqdn = "${aws_service_discovery_service.mock_pay.name}.${var.aws_service_discovery_private_dns_namespace.name}"
}
...
locals {
  mock_pay_url = "https://${data.aws_default_tags.current.tags.environment-name}-mock-pay.app.modernising.opg.service.justice.gov.uk"
