...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_allow_list"></a> [allow\_list](#module\_allow\_list) | git@github.com:ministryofjustice/opg-terraform-aws-moj-ip-allow-list.git | v2.3.0 |
...
| [aws_iam_role.event_received](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_role) | data source |
