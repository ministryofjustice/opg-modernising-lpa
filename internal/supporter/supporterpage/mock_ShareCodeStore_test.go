...
func (_m *mockShareCodeStore) Delete(ctx context.Context, data sharecodedata.Data) error {
...
func (_c *mockShareCodeStore_Delete_Call) Run(run func(ctx context.Context, data sharecodedata.Data)) *mockShareCodeStore_Delete_Call {
...
func (_c *mockShareCodeStore_Delete_Call) RunAndReturn(run func(context.Context, sharecodedata.Data) error) *mockShareCodeStore_Delete_Call {
	_c.Call.Return(run)
	return _c
}

// GetDonor provides a mock function with given fields: ctx
func (_m *mockShareCodeStore) GetDonor(ctx context.Context) (sharecodedata.Data, error) {
	ret := _m.Called(ctx)
	...
	if rf, ok := ret.Get(0).(func(context.Context) sharecodedata.Data); ok {
		r0 = rf(ctx)
	} else {
...
func (_c *mockShareCodeStore_GetDonor_Call) Return(_a0 sharecodedata.Data, _a1 error) *mockShareCodeStore_GetDonor_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockShareCodeStore_GetDonor_Call) RunAndReturn(run func(context.Context) (sharecodedata.Data, error)) *mockShareCodeStore_GetDonor_Call {
	_c.Call.Return(run)
	return _c
}

// PutDonor provides a mock function with given fields: ctx, shareCode, data
func (_m *mockShareCodeStore) PutDonor(ctx context.Context, shareCode string, data sharecodedata.Data) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, sharecodedata.Data) error); ok {
...
func (_c *mockShareCodeStore_PutDonor_Call) Run(run func(ctx context.Context, shareCode string, data sharecodedata.Data)) *mockShareCodeStore_PutDonor_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(sharecodedata.Data))
	})
	return _c
}
...
func (_c *mockShareCodeStore_PutDonor_Call) RunAndReturn(run func(context.Context, string, sharecodedata.Data) error) *mockShareCodeStore_PutDonor_Call {
	_c.Call.Return(run)
	return _c
}
