...
func (_m *mockOrganisationStore) Create(ctx context.Context, member *supporterdata.Member, name string) (*supporterdata.Organisation, error) {
	...
	var r0 *supporterdata.Organisation
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *supporterdata.Member, string) (*supporterdata.Organisation, error)); ok {
		return rf(ctx, member, name)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *supporterdata.Member, string) *supporterdata.Organisation); ok {
		r0 = rf(ctx, member, name)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*supporterdata.Organisation)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *supporterdata.Member, string) error); ok {
...
func (_c *mockOrganisationStore_Create_Call) Run(run func(ctx context.Context, member *supporterdata.Member, name string)) *mockOrganisationStore_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*supporterdata.Member), args[2].(string))
	})
	return _c
}

func (_c *mockOrganisationStore_Create_Call) Return(_a0 *supporterdata.Organisation, _a1 error) *mockOrganisationStore_Create_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockOrganisationStore_Create_Call) RunAndReturn(run func(context.Context, *supporterdata.Member, string) (*supporterdata.Organisation, error)) *mockOrganisationStore_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *mockOrganisationStore) Get(ctx context.Context) (*supporterdata.Organisation, error) {
	ret := _m.Called(ctx)
	...
	var r0 *supporterdata.Organisation
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (*supporterdata.Organisation, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) *supporterdata.Organisation); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*supporterdata.Organisation)
...
func (_c *mockOrganisationStore_Get_Call) Return(_a0 *supporterdata.Organisation, _a1 error) *mockOrganisationStore_Get_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockOrganisationStore_Get_Call) RunAndReturn(run func(context.Context) (*supporterdata.Organisation, error)) *mockOrganisationStore_Get_Call {
	_c.Call.Return(run)
	return _c
}

// Put provides a mock function with given fields: ctx, organisation
func (_m *mockOrganisationStore) Put(ctx context.Context, organisation *supporterdata.Organisation) error {
...
func (_c *mockOrganisationStore_Put_Call) Run(run func(ctx context.Context, organisation *supporterdata.Organisation)) *mockOrganisationStore_Put_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*supporterdata.Organisation))
	})
	return _c
}
...
func (_c *mockOrganisationStore_Put_Call) RunAndReturn(run func(context.Context, *supporterdata.Organisation) error) *mockOrganisationStore_Put_Call {
	_c.Call.Return(run)
	return _c
}

// SoftDelete provides a mock function with given fields: ctx, organisation
func (_m *mockOrganisationStore) SoftDelete(ctx context.Context, organisation *supporterdata.Organisation) error {
	ret := _m.Called(ctx, organisation)
