...
func (_m *mockProgressTracker) Progress(lpa *lpadata.Lpa) page.Progress {
	ret := _m.Called(lpa)
	...
	if rf, ok := ret.Get(0).(func(*lpadata.Lpa) page.Progress); ok {
		r0 = rf(lpa)
	} else {
...
func (_c *mockProgressTracker_Progress_Call) RunAndReturn(run func(*lpadata.Lpa) page.Progress) *mockProgressTracker_Progress_Call {
	_c.Call.Return(run)
	return _c
}
