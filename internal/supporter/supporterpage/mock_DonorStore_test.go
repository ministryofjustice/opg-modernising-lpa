...
func (_m *mockDonorStore) DeleteDonorAccess(ctx context.Context, link supporterdata.LpaLink) error {
...
func (_c *mockDonorStore_DeleteDonorAccess_Call) Run(run func(ctx context.Context, link supporterdata.LpaLink)) *mockDonorStore_DeleteDonorAccess_Call {
...
func (_c *mockDonorStore_DeleteDonorAccess_Call) RunAndReturn(run func(context.Context, supporterdata.LpaLink) error) *mockDonorStore_DeleteDonorAccess_Call {
	_c.Call.Return(run)
	return _c
}
