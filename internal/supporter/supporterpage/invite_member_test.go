...
func TestPostInviteMember(t *testing.T) {
	...
	err := InviteMember(nil, memberStore, notifyClient, testGenerateInviteFn, "http://base")(testOrgMemberAppData, w, r, organisation, nil)
	resp := w.Result()
...
func TestPostInviteMemberWhenCreateMemberInviteErrors(t *testing.T) {
	...
	err := InviteMember(nil, memberStore, nil, testGenerateInviteFn, "http://base")(testAppData, w, r, &supporterdata.Organisation{}, nil)
	assert.Equal(t, expectedError, err)
}
...
func TestPostInviteMemberWhenNotifySendErrors(t *testing.T) {
	...
	err := InviteMember(nil, memberStore, notifyClient, testGenerateInviteFn, "http://base")(testAppData, w, r, &supporterdata.Organisation{}, nil)
	assert.Equal(t, expectedError, err)
}
