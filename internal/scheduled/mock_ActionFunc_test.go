...
func (_m *mockActionFunc) Execute(ctx context.Context, row Row) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, Row) error); ok {
		r0 = rf(ctx, row)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *mockActionFunc_Execute_Call) Run(run func(ctx context.Context, row Row)) *mockActionFunc_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(Row))
	})
	return _c
}
...
func (_c *mockActionFunc_Execute_Call) RunAndReturn(run func(context.Context, Row) error) *mockActionFunc_Execute_Call {
	_c.Call.Return(run)
	return _c
}
