...
func (_m *mockScheduledStore) Pop(ctx context.Context, at time.Time) (Row, error) {
...
func (_c *mockScheduledStore_Pop_Call) Return(_a0 Row, _a1 error) *mockScheduledStore_Pop_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockScheduledStore_Pop_Call) RunAndReturn(run func(context.Context, time.Time) (Row, error)) *mockScheduledStore_Pop_Call {
	_c.Call.Return(run)
	return _c
}
