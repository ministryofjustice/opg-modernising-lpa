...
func (_m *mockCronStore) Pop(ctx context.Context, at time.Time) (Event, error) {
...
func (_c *mockCronStore_Pop_Call) Return(_a0 Event, _a1 error) *mockCronStore_Pop_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockCronStore_Pop_Call) RunAndReturn(run func(context.Context, time.Time) (Event, error)) *mockCronStore_Pop_Call {
	_c.Call.Return(run)
	return _c
}
