...
func NewSender(shareCodeStore ShareCodeStore, notifyClient NotifyClient, appPublicURL string, eventClient EventClient, certificateProviderStore CertificateProviderStore) *Sender {
	return &Sender{
		shareCodeStore:           shareCodeStore,
		notifyClient:             notifyClient,
