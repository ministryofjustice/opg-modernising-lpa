...
func TestShareCodeSenderSendOnlineCertificateProviderPrompt(t *testing.T) {
	...
	err := sender.SendOnlineCertificateProviderPrompt(ctx, testAppData, donor, lpa)
...
func TestShareCodeSenderSendOnlineCertificateProviderPromptWhenShareCodeErrors(t *testing.T) {
	...
	err := sender.SendOnlineCertificateProviderPrompt(context.Background(), testAppData, &donordata.Provided{}, &lpadata.Lpa{})
...
func TestShareCodeSenderSendOnlineCertificateProviderPromptWhenEmailErrors(t *testing.T) {
	...
	err := sender.SendOnlineCertificateProviderPrompt(ctx, testAppData, &donordata.Provided{}, &lpadata.Lpa{})
