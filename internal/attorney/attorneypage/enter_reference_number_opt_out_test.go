...
func TestPostEnterReferenceNumberOptOut(t *testing.T) {
	...
	assert.Equal(t, page.PathAttorneyConfirmDontWantToBeAttorneyLoggedOut.Format()+"?code=e9cee71ab932fde863338d08be4de9dfe39ea049bdafb342ce659ec5450b69ae", resp.Header.Get("Location"))
}
