...
func (_m *mockAttorneyStore) Create(ctx context.Context, shareCode sharecode.ShareCodeData, email string) (*attorneydata.Provided, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, sharecode.ShareCodeData, string) (*attorneydata.Provided, error)); ok {
		return rf(ctx, shareCode, email)
	}
	if rf, ok := ret.Get(0).(func(context.Context, sharecode.ShareCodeData, string) *attorneydata.Provided); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, sharecode.ShareCodeData, string) error); ok {
...
func (_c *mockAttorneyStore_Create_Call) Run(run func(ctx context.Context, shareCode sharecode.ShareCodeData, email string)) *mockAttorneyStore_Create_Call {
