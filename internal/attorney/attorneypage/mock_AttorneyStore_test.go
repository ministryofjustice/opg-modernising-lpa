...
func (_m *mockAttorneyStore) Create(ctx context.Context, shareCode sharecode.Data, email string) (*attorneydata.Provided, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, sharecode.Data, string) (*attorneydata.Provided, error)); ok {
		return rf(ctx, shareCode, email)
	}
	if rf, ok := ret.Get(0).(func(context.Context, sharecode.Data, string) *attorneydata.Provided); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, sharecode.Data, string) error); ok {
...
func (_c *mockAttorneyStore_Create_Call) Run(run func(ctx context.Context, shareCode sharecode.Data, email string)) *mockAttorneyStore_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(sharecode.Data), args[2].(string))
	})
	return _c
}
...
func (_c *mockAttorneyStore_Create_Call) RunAndReturn(run func(context.Context, sharecode.Data, string) (*attorneydata.Provided, error)) *mockAttorneyStore_Create_Call {
	_c.Call.Return(run)
	return _c
}
