...
func Register(
	...
	handleRoot(attorney.PathLogin, None,
		page.Login(oneLoginClient, sessionStore, random.String, attorney.PathLoginCallback))
	handleRoot(attorney.PathLoginCallback, None,
		page.LoginCallback(logger, oneLoginClient, sessionStore, attorney.PathEnterReferenceNumber, dashboardStore, actor.TypeAttorney))
	handleRoot(attorney.PathEnterReferenceNumber, RequireSession,
		EnterReferenceNumber(tmpls.Get("enter_reference_number.gohtml"), shareCodeStore, sessionStore, attorneyStore))
	handleRoot(attorney.PathEnterReferenceNumberOptOut, None,
		EnterReferenceNumberOptOut(tmpls.Get("enter_reference_number_opt_out.gohtml"), shareCodeStore, sessionStore))
	handleRoot(attorney.PathConfirmDontWantToBeAttorneyLoggedOut, None,
	...
	handleRoot(attorney.PathYouHaveDecidedNotToBeAttorney, None,
