...
func ReadTheLpa(tmpl template.Template, attorneyStore AttorneyStore, bundle Bundle) Handler {
	return func(appData appcontext.Data, w http.ResponseWriter, r *http.Request, attorneyProvidedDetails *attorneydata.Provided, lpa *lpadata.Lpa) error {
		...
		if err != nil || bannerLanguage.Empty() {
			...
			return attorney.PathReadTheLpa.RedirectQuery(w, r, appData, lpa.LpaID, url.Values{
