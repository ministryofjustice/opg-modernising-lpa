...
func (_m *mockHandler) Execute(data page.AppData, w http.ResponseWriter, r *http.Request, details *attorneydata.Provided) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(page.AppData, http.ResponseWriter, *http.Request, *attorneydata.Provided) error); ok {
...
func (_c *mockHandler_Execute_Call) Run(run func(data page.AppData, w http.ResponseWriter, r *http.Request, details *attorneydata.Provided)) *mockHandler_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(page.AppData), args[1].(http.ResponseWriter), args[2].(*http.Request), args[3].(*attorneydata.Provided))
	})
	return _c
}
...
func (_c *mockHandler_Execute_Call) RunAndReturn(run func(page.AppData, http.ResponseWriter, *http.Request, *attorneydata.Provided) error) *mockHandler_Execute_Call {
	_c.Call.Return(run)
	return _c
}
