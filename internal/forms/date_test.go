...
func TestDate_ParsePostForm(t *testing.T) {
	...
	t.Run("NotEmpty", func(t *testing.T) {
		...
		t.Run("valid", func(t *testing.T) {
			...
			assert.False(t, aForm.D.ErrorPart("year"))
			assert.False(t, aForm.D.ErrorPart("month"))
			assert.False(t, aForm.D.ErrorPart("day"))
			assert.False(t, aForm.D.ErrorPart("?"))
		})
		...
		t.Run("missing year", func(t *testing.T) {
			...
			assert.True(t, aForm.D.ErrorPart("year"))
			assert.False(t, aForm.D.ErrorPart("month"))
			assert.False(t, aForm.D.ErrorPart("day"))
			assert.False(t, aForm.D.ErrorPart("?"))
		})
		...
		t.Run("missing month and day", func(t *testing.T) {
			...
			assert.False(t, aForm.D.ErrorPart("year"))
			assert.True(t, aForm.D.ErrorPart("month"))
			assert.True(t, aForm.D.ErrorPart("day"))
			assert.False(t, aForm.D.ErrorPart("?"))
		})
	})
