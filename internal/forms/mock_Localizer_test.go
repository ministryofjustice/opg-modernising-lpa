...
// Format provides a mock function with given fields: msgid, data
func (_m *mockLocalizer) Format(msgid string, data map[string]interface{}) string {
	ret := _m.Called(msgid, data)
...
func (_e *mockLocalizer_Expecter) Format(msgid interface{}, data interface{}) *mockLocalizer_Format_Call {
	return &mockLocalizer_Format_Call{Call: _e.mock.On("Format", msgid, data)}
}

func (_c *mockLocalizer_Format_Call) Run(run func(msgid string, data map[string]interface{})) *mockLocalizer_Format_Call {
