...
var (
	productionTemplates = map[Template]string{
		...
		CertificateProviderProvideCertificatePromptEmail:              "453917cd-d8bb-44af-90a1-d73ae0f3fd07",
	...
	testingTemplates = map[Template]string{
		...
		CertificateProviderProvideCertificatePromptEmail:              "dd864a1a-64b4-4b4e-b810-86267ebd6476",
