...
func TestSendActorEmail(t *testing.T) {
	testcases := map[string]string{
		...
		"previously created before window": `{"notifications":[{"created_at":"2020-01-02T02:53:06Z"}]}`,
	}
...
func TestSendActorEmailWhenAlreadyRecentlyCreated(t *testing.T) {
	testcases := map[string]string{
		"previously created":       `{"notifications":[{"created_at":"2020-01-02T02:54:06Z"}]}`,
		"previously created mixed": `{"notifications":[{"created_at":"2020-01-02T02:53:06Z"}, {"created_at":"2020-01-02T02:54:06Z"}, {"created_at":"2020-01-02T02:52:06Z"}]}`,
	}
