...
func TestRegister(t *testing.T) {
	...
	Register(mux, &mockLogger{}, template.Templates{}, &mockSessionStore{}, &mockVoucherStore{}, &mockOneLoginClient{}, &mockAccessCodeStore{}, &mockDashboardStore{}, nil, &mockLpaStoreResolvingService{}, &mockNotifyClient{}, &mockDonorStore{}, &mockLpaStoreClient{}, &mockScheduledStore{}, "http://example.com/start", &mockLocalizer{})
