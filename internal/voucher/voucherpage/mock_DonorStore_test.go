...
// FailVoucher provides a mock function with given fields: ctx, provided
func (_m *mockDonorStore) FailVoucher(ctx context.Context, provided *donordata.Provided) error {
...
func (_e *mockDonorStore_Expecter) FailVoucher(ctx interface{}, provided interface{}) *mockDonorStore_FailVoucher_Call {
	return &mockDonorStore_FailVoucher_Call{Call: _e.mock.On("FailVoucher", ctx, provided)}
}

func (_c *mockDonorStore_FailVoucher_Call) Run(run func(ctx context.Context, provided *donordata.Provided)) *mockDonorStore_FailVoucher_Call {
...
func (_c *mockDonorStore_FailVoucher_Call) RunAndReturn(run func(context.Context, *donordata.Provided) error) *mockDonorStore_FailVoucher_Call {
	_c.Call.Return(run)
	return _c
}
