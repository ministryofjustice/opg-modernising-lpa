...
func (_m *mockSessionStore) Csrf(r *http.Request) (*sesh.CsrfSession, error) {
	ret := _m.Called(r)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*http.Request) (*sesh.CsrfSession, error)); ok {
		return rf(r)
	}
...
func (_c *mockSessionStore_Csrf_Call) Return(_a0 *sesh.CsrfSession, _a1 error) *mockSessionStore_Csrf_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockSessionStore_Csrf_Call) RunAndReturn(run func(*http.Request) (*sesh.CsrfSession, error)) *mockSessionStore_Csrf_Call {
	_c.Call.Return(run)
	return _c
}
