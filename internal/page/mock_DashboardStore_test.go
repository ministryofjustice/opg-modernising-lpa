...
func (_m *mockDashboardStore) GetAll(ctx context.Context) (DashboardResults, error) {
	ret := _m.Called(ctx)
	...
	var r0 DashboardResults
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (DashboardResults, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) DashboardResults); ok {
		r0 = rf(ctx)
	} else {
		r0 = ret.Get(0).(DashboardResults)
	}
...
func (_c *mockDashboardStore_GetAll_Call) Return(results DashboardResults, err error) *mockDashboardStore_GetAll_Call {
	_c.Call.Return(results, err)
	return _c
}

func (_c *mockDashboardStore_GetAll_Call) RunAndReturn(run func(context.Context) (DashboardResults, error)) *mockDashboardStore_GetAll_Call {
	_c.Call.Return(run)
	return _c
}
