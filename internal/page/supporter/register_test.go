...
func TestRegister(t *testing.T) {
	...
	Register(mux, template.Templates{}, &onelogin.Client{}, &mockSessionStore{}, &mockOrganisationStore{}, nil, &notify.Client{}, "http://base", &mockMemberStore{}, &search.Client{}, &mockDonorStore{}, &mockShareCodeStore{}, &mockCertificateProviderStore{}, &mockAttorneyStore{}, &mockProgressTracker{}, &lpastore.Client{})
