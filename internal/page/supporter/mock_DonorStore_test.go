...
func (_m *mockDonorStore) DeleteDonorAccess(ctx context.Context, shareCodeData sharecode.Data) error {
...
func (_c *mockDonorStore_DeleteDonorAccess_Call) Run(run func(ctx context.Context, shareCodeData sharecode.Data)) *mockDonorStore_DeleteDonorAccess_Call {
...
func (_c *mockDonorStore_DeleteDonorAccess_Call) RunAndReturn(run func(context.Context, sharecode.Data) error) *mockDonorStore_DeleteDonorAccess_Call {
	_c.Call.Return(run)
	return _c
}
