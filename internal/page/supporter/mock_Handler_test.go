...
func (_c *mockHandler_Execute_Call) Run(run func(data page.AppData, w http.ResponseWriter, r *http.Request)) *mockHandler_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(page.AppData), args[1].(http.ResponseWriter), args[2].(*http.Request))
	})
	return _c
}
...
func (_c *mockHandler_Execute_Call) RunAndReturn(run func(page.AppData, http.ResponseWriter, *http.Request) error) *mockHandler_Execute_Call {
	_c.Call.Return(run)
	return _c
}
