...
func TestRegister(t *testing.T) {
	...
	Register(mux, &slog.Logger{}, template.Templates{}, template.Templates{}, nil, nil, &onelogin.Client{}, nil, nil, nil, nil, &place.Client{}, &notify.Client{}, nil, &mockDashboardStore{}, nil)
