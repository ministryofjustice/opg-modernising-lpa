...
func TestGetIdentityWithOneLoginCallback(t *testing.T) {
	...
	donorStore.
		On("GetAny", r.Context()).
		Return(&actor.Lpa{CertificateProvider: actor.CertificateProvider{FirstNames: "John", LastName: "Doe"}}, nil)
...
func TestGetIdentityWithOneLoginCallbackWhenIdentityNotConfirmed(t *testing.T) {
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			...
			donorStore.
				On("GetAny", r.Context()).
				Return(&actor.Lpa{CertificateProvider: actor.CertificateProvider{}}, nil)
...
func TestGetIdentityWithOneLoginCallbackWhenGetDonorStoreError(t *testing.T) {
	...
	donorStore.
		On("GetAny", r.Context()).
		Return(&actor.Lpa{CertificateProvider: actor.CertificateProvider{}}, expectedError)
...
func TestGetIdentityWithOneLoginCallbackWhenReturning(t *testing.T) {
	...
	donorStore.
		On("GetAny", r.Context()).
		Return(&actor.Lpa{CertificateProvider: actor.CertificateProvider{FirstNames: "first-names", LastName: "last-name"}}, nil)
