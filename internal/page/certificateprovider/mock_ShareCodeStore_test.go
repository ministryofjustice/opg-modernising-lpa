...
func (_m *mockShareCodeStore) Put(ctx context.Context, actorType temporary.ActorType, shareCode string, shareCodeData sharecode.ShareCodeData) error {
...
func (_c *mockShareCodeStore_Put_Call) Run(run func(ctx context.Context, actorType temporary.ActorType, shareCode string, shareCodeData sharecode.ShareCodeData)) *mockShareCodeStore_Put_Call {
	_c.Call.Run(func(args mock.Arguments) {
