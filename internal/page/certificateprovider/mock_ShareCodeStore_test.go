...
func (_m *mockShareCodeStore) Put(ctx context.Context, actorType actor.Type, shareCode string, shareCodeData actor.ShareCodeData) error {
...
func (_c *mockShareCodeStore_Put_Call) Run(run func(ctx context.Context, actorType actor.Type, shareCode string, shareCodeData actor.ShareCodeData)) *mockShareCodeStore_Put_Call {
	_c.Call.Run(func(args mock.Arguments) {
