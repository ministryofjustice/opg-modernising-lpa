...
type CertificateProviderStore interface {
	Create(ctx context.Context, donorSessionID string, certificateProviderUID actoruid.UID, donorActingOn actor.ActingOn) (*actor.CertificateProviderProvidedDetails, error)
