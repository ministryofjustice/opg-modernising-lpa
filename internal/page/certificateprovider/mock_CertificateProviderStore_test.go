...
// Create provides a mock function with given fields: ctx, donorSessionID, certificateProviderUID, donorChannel
func (_m *mockCertificateProviderStore) Create(ctx context.Context, donorSessionID string, certificateProviderUID actoruid.UID, donorChannel actor.Channel) (*actor.CertificateProviderProvidedDetails, error) {
	ret := _m.Called(ctx, donorSessionID, certificateProviderUID, donorChannel)
	...
	if rf, ok := ret.Get(0).(func(context.Context, string, actoruid.UID, actor.Channel) (*actor.CertificateProviderProvidedDetails, error)); ok {
		return rf(ctx, donorSessionID, certificateProviderUID, donorChannel)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, actoruid.UID, actor.Channel) *actor.CertificateProviderProvidedDetails); ok {
		r0 = rf(ctx, donorSessionID, certificateProviderUID, donorChannel)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, actoruid.UID, actor.Channel) error); ok {
		r1 = rf(ctx, donorSessionID, certificateProviderUID, donorChannel)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *mockCertificateProviderStore_Expecter) Create(ctx interface{}, donorSessionID interface{}, certificateProviderUID interface{}, donorChannel interface{}) *mockCertificateProviderStore_Create_Call {
	return &mockCertificateProviderStore_Create_Call{Call: _e.mock.On("Create", ctx, donorSessionID, certificateProviderUID, donorChannel)}
}

func (_c *mockCertificateProviderStore_Create_Call) Run(run func(ctx context.Context, donorSessionID string, certificateProviderUID actoruid.UID, donorChannel actor.Channel)) *mockCertificateProviderStore_Create_Call {
