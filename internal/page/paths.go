...
const (
	...
	PathAttorneyEnterReferenceNumber                                       = Path("/attorney-enter-access-code")
	PathAttorneyEnterReferenceNumberOptOut                                 = Path("/attorney-enter-access-code-opt-out")
	...
	PathCertificateProviderEnterReferenceNumber                            = Path("/certificate-provider-enter-access-code")
	PathCertificateProviderEnterReferenceNumberOptOut                      = Path("/certificate-provider-enter-access-code-opt-out")
	...
	PathSupporterEnterReferenceNumber                                      = Path("/supporter-access-code")
	...
	PathVoucherEnterReferenceNumber                                        = Path("/voucher-enter-access-code")
