...
func (_m *mockDocumentStore) Submit(_a0 context.Context, _a1 *page.Lpa, _a2 page.Documents) error {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *page.Lpa, page.Documents) error); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		r0 = ret.Error(0)
	}
