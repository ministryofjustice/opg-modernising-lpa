...
func TestVoucherMatches(t *testing.T) {
	donor := &actor.DonorProvidedDetails{
		...
		AuthorisedSignatory: actor.AuthorisedSignatory{FirstNames: "p", LastName: "q"},
		IndependentWitness:  actor.IndependentWitness{FirstNames: "r", LastName: "s"},
	}
	...
	assert.Equal(t, actor.TypeAuthorisedSignatory, voucherMatches(donor, "p", "q"))
	assert.Equal(t, actor.TypeIndependentWitness, voucherMatches(donor, "r", "s"))
