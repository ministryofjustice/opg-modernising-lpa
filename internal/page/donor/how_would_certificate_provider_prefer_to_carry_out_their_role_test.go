...
func TestGetHowWouldCertificateProviderPreferToCarryOutTheirRole(t *testing.T) {
	...
	err := HowWouldCertificateProviderPreferToCarryOutTheirRole(template.Execute, nil)(testAppData, w, r, &actor.Lpa{})
	resp := w.Result()
...
func TestPostHowWouldCertificateProviderPreferToCarryOutTheirRole(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.carryOutBy.String(), func(t *testing.T) {
			...
			err := HowWouldCertificateProviderPreferToCarryOutTheirRole(nil, donorStore)(testAppData, w, r, &actor.Lpa{ID: "lpa-id"})
			resp := w.Result()
...
func TestPostHowWouldCertificateProviderPreferToCarryOutTheirRoleWhenStoreErrors(t *testing.T) {
	...
	err := HowWouldCertificateProviderPreferToCarryOutTheirRole(nil, donorStore)(testAppData, w, r, &actor.Lpa{})
