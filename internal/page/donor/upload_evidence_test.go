...
func TestGetUploadEvidence(t *testing.T) {
	...
	err := UploadEvidence(template.Execute, nil, nil, documentStore)(testAppData, w, r, &page.Lpa{FeeType: page.FullFee})
	resp := w.Result()
...
func TestGetUploadEvidenceWhenTaskPending(t *testing.T) {
	...
	err := UploadEvidence(nil, nil, nil, nil)(testAppData, w, r, &page.Lpa{ID: "lpa-id", FeeType: page.FullFee, Tasks: page.Tasks{PayForLpa: actor.PaymentTaskPending}})
	resp := w.Result()
...
func TestPostUploadEvidenceWithUploadActionAcceptedFileTypes(t *testing.T) {
	...
	for _, filename := range testCases {
		t.Run(filename, func(t *testing.T) {
			...
			err := UploadEvidence(template.Execute, nil, func() string { return "a-uid" }, documentStore)(testAppData, w, r, &page.Lpa{ID: "lpa-id", UID: "lpa-uid", FeeType: page.HalfFee})
			assert.Nil(t, err)
		})
	}
}
...
func TestPostUploadEvidenceWithPayAction(t *testing.T) {
	...
	err := UploadEvidence(nil, payer, func() string { return "a-uid" }, documentStore)(testAppData, w, r, &page.Lpa{ID: "lpa-id", UID: "lpa-uid", FeeType: page.HalfFee})
...
func TestPostUploadEvidenceWithPayActionWithInfectedFilesWhenDocumentStoreGetAllErrors(t *testing.T) {
	...
	err := UploadEvidence(nil, nil, func() string { return "a-uid" }, documentStore)(testAppData, w, r, &page.Lpa{ID: "lpa-id", UID: "lpa-uid", FeeType: page.HalfFee})
...
func TestPostUploadEvidenceWhenBadCsrfField(t *testing.T) {
	...
	err := UploadEvidence(template.Execute, nil, nil, documentStore)(testAppData, w, r, &page.Lpa{ID: "lpa-id", FeeType: page.FullFee})
	resp := w.Result()
...
func TestPostUploadEvidenceNumberOfFilesLimitPassed(t *testing.T) {
	...
	err := UploadEvidence(template.Execute, nil, nil, documentStore)(testAppData, w, r, &page.Lpa{UID: "lpa-uid", FeeType: page.FullFee})
	assert.Nil(t, err)
}
...
func TestGetUploadEvidenceDeleteEvidence(t *testing.T) {
	...
	err := UploadEvidence(template.Execute, nil, func() string { return "a-uid" }, documentStore)(testAppData, w, r, &page.Lpa{})
...
func TestGetUploadEvidenceDeleteEvidenceWhenDocumentStoreDeleteError(t *testing.T) {
	...
	err := UploadEvidence(nil, nil, func() string { return "a-uid" }, documentStore)(testAppData, w, r, &page.Lpa{})
...
func TestPostUploadEvidenceWithCloseConnectionAction(t *testing.T) {
	...
	err := UploadEvidence(template.Execute, nil, nil, documentStore)(testAppData, w, r, &page.Lpa{UID: "lpa-uid", FeeType: page.HalfFee})
...
func TestPostUploadEvidenceWithCloseConnectionActionWhenDocumentStoreDeleteError(t *testing.T) {
	...
	err := UploadEvidence(nil, nil, nil, documentStore)(testAppData, w, r, &page.Lpa{UID: "lpa-uid", FeeType: page.HalfFee})
