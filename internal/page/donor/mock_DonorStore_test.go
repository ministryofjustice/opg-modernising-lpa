...
func (_m *mockDonorStore) Link(ctx context.Context, data actor.ShareCodeData, donorEmail string) error {
...
func (_c *mockDonorStore_Link_Call) Run(run func(ctx context.Context, data actor.ShareCodeData, donorEmail string)) *mockDonorStore_Link_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *mockDonorStore_Link_Call) RunAndReturn(run func(context.Context, actor.ShareCodeData, string) error) *mockDonorStore_Link_Call {
	_c.Call.Return(run)
	return _c
}
