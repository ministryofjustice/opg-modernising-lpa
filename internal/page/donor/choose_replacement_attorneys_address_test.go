...
func TestGetChooseReplacementAttorneysAddress(t *testing.T) {
	...
	err := ChooseReplacementAttorneysAddress(nil, template.Execute, nil, nil)(testAppData, w, r, &actor.Lpa{ReplacementAttorneys: actor.Attorneys{Attorneys: []actor.Attorney{ra}}})
	resp := w.Result()
...
func TestPostChooseReplacementAttorneysAddressSkip(t *testing.T) {
	...
	err := ChooseReplacementAttorneysAddress(nil, nil, nil, donorStore)(testAppData, w, r, &actor.Lpa{
		ID: "lpa-id",
...
func TestPostChooseReplacementAttorneysAddressManualWhenStoreErrors(t *testing.T) {
	...
	err := ChooseReplacementAttorneysAddress(nil, nil, nil, donorStore)(testAppData, w, r, &actor.Lpa{ReplacementAttorneys: actor.Attorneys{Attorneys: []actor.Attorney{{ID: "123"}}}})
...
func TestPostChooseReplacementAttorneysAddressManualWhenValidationError(t *testing.T) {
	...
	err := ChooseReplacementAttorneysAddress(nil, template.Execute, nil, nil)(testAppData, w, r, &actor.Lpa{ReplacementAttorneys: actor.Attorneys{Attorneys: []actor.Attorney{{ID: "123"}}}})
	resp := w.Result()
...
func TestPostChooseReplacementAttorneysPostcodeSelectWhenValidationError(t *testing.T) {
	...
	err := ChooseReplacementAttorneysAddress(nil, template.Execute, addressClient, nil)(testAppData, w, r, &actor.Lpa{ReplacementAttorneys: actor.Attorneys{Attorneys: []actor.Attorney{{ID: "123"}}}})
	resp := w.Result()
...
func TestPostChooseReplacementAttorneysPostcodeLookupError(t *testing.T) {
	...
	err := ChooseReplacementAttorneysAddress(logger, template.Execute, addressClient, nil)(testAppData, w, r, &actor.Lpa{ReplacementAttorneys: actor.Attorneys{Attorneys: []actor.Attorney{{ID: "123"}}}})
	resp := w.Result()
...
func TestPostChooseReplacementAttorneysPostcodeLookupInvalidPostcodeError(t *testing.T) {
	...
	err := ChooseReplacementAttorneysAddress(logger, template.Execute, addressClient, nil)(testAppData, w, r, &actor.Lpa{
...
func TestPostChooseReplacementAttorneysAddressReuse(t *testing.T) {
	...
	err := ChooseReplacementAttorneysAddress(nil, template.Execute, nil, nil)(testAppData, w, r, &actor.Lpa{
