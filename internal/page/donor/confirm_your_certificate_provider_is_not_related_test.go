...
func TestGetConfirmYourCertificateProviderIsNotRelated(t *testing.T) {
	...
	err := ConfirmYourCertificateProviderIsNotRelated(template.Execute, nil)(testAppData, w, r, &page.Lpa{})
	resp := w.Result()
...
func TestGetConfirmYourCertificateProviderIsNotRelatedFromStore(t *testing.T) {
	w := httptest.NewRecorder()
	r, _ := http.NewRequest(http.MethodGet, "/", nil)
...
func TestPostConfirmYourCertificateProviderIsNotRelated(t *testing.T) {
	...
	err := ConfirmYourCertificateProviderIsNotRelated(nil, donorStore)(testAppData, w, r, &page.Lpa{
		ID:                             "lpa-id",
		Donor:                          actor.Donor{CanSign: form.Yes},
		HasSentApplicationUpdatedEvent: true,
		Tasks: page.Tasks{
