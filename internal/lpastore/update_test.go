...
func TestDevOnlyFuncsDoNotWorkInProd(t *testing.T) {
	...
	assert.Error(t, prodClient.SendPaperCertificateProviderSign(context.Background(), "a"))
...
func TestClientSendPaperCertificateProviderSign(t *testing.T) {
	json := `{"type":"CERTIFICATE_PROVIDER_SIGN","changes":[{"key":"/certificateProvider/signedAt","old":null,"new":"2000-01-02T03:04:05.000000006Z"},{"key":"/certificateProvider/contactLanguagePreference","old":null,"new":"en"},{"key":"/certificateProvider/address/line1","old":null,"new":"Line 1"},{"key":"/certificateProvider/address/town","old":null,"new":"Town"},{"key":"/certificateProvider/address/postcode","old":null,"new":"B14 7ED"},{"key":"/certificateProvider/address/country","old":null,"new":"GB"},{"key":"/certificateProvider/channel","old":null,"new":"paper"}]}`
	...
	client := New("http://base", secretsClient, "secret", doer)
	client.now = func() time.Time { return time.Date(2000, time.January, 2, 3, 4, 5, 6, time.UTC) }
	err := client.SendPaperCertificateProviderSign(ctx, "lpa-uid")
