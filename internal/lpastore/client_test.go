	...
	pact.
		...
		WithRequest(dsl.Request{
			...
			Body: dsl.Like(map[string]any{
				...
				"howAttorneysMakeDecisions":                   dsl.Regex("jointly", "jointly|jointly-and-severally|mixed"),
				"howAttorneysMakeDecisionsDetails":            dsl.String("hmm"),
				"howReplacementAttorneysMakeDecisions":        dsl.Regex("jointly", "jointly|jointly-and-severally|mixed"),
				"howReplacementAttorneysMakeDecisionsDetails": dsl.String("hmm"),
				"howReplacementAttorneysStepIn":               dsl.Regex("all", "all|one|other"),
