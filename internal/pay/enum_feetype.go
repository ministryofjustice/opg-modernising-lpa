...
func _() {
	...
	_ = x[NoFee-3]
	_ = x[HardshipFee-4]
	_ = x[RepeatApplicationFee-5]
}

const _FeeType_name = "FullFeeHalfFeeQuarterFeeNoFeeHardshipFeeRepeatApplicationFee"

var _FeeType_index = [...]uint8{0, 7, 14, 24, 29, 40, 60}
