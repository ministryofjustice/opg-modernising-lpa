...
type uidStore struct {
	...
	now                 func() time.Time
	searchClientFactory func() (*search.Client, error)
	searchClient        *search.Client
}

func NewUidStore(dynamoClient DynamoUpdateClient, searchClientFactory func() (*search.Client, error), now func() time.Time) *uidStore {
