...
func TestDonorStorePut(t *testing.T) {
	...
	testcases := map[string]struct {
		...
		"no uid": {
			...
			saved: &page.Lpa{PK: "LPA#5", Hash: 13284817533099450179, SK: "#DONOR#an-id", ID: "5", HasSentApplicationUpdatedEvent: true},
		},
		"with uid": {
			input: &page.Lpa{PK: "LPA#5", Hash: 5, SK: "#DONOR#an-id", ID: "5", HasSentApplicationUpdatedEvent: true, UID: "M"},
			saved: &page.Lpa{PK: "LPA#5", Hash: 10720866432253210668, SK: "#DONOR#an-id", ID: "5", HasSentApplicationUpdatedEvent: true, UID: "M", UpdatedAt: testNow},
		},
	}
...
func TestDonorStoreCreate(t *testing.T) {
	ctx := page.ContextWithSessionData(context.Background(), &page.SessionData{SessionID: "an-id"})
	lpa := &page.Lpa{PK: "LPA#10100000", SK: "#DONOR#an-id", Hash: 7193312000565147901, ID: "10100000", CreatedAt: testNow}
