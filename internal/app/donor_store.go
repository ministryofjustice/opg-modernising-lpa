...
func (s *donorStore) Create(ctx context.Context) (*actor.Lpa, error) {
...
func (s *donorStore) GetAny(ctx context.Context) (*actor.Lpa, error) {
	data, err := page.SessionDataFromContext(ctx)
	if err != nil {
		return nil, err
	}
...
func (s *donorStore) Get(ctx context.Context) (*actor.Lpa, error) {
	data, err := page.SessionDataFromContext(ctx)
	if err != nil {
		return nil, err
	}
...
func (s *donorStore) Latest(ctx context.Context) (*actor.Lpa, error) {
	data, err := page.SessionDataFromContext(ctx)
	if err != nil {
		return nil, err
	}
...
func (s *donorStore) Put(ctx context.Context, lpa *actor.Lpa) error {
