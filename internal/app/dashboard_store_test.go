...
func TestDashboardStoreGetAll(t *testing.T) {
	...
	for name, attributeValues := range testCases {
		t.Run(name, func(t *testing.T) {
			...
			assert.Equal(t, []page.LpaAndActorTasks{{Lpa: lpa456, CertificateProvider: actor.CertificateProviderTasks{ConfirmYourDetails: actor.TaskCompleted}}}, certificateProvider)
