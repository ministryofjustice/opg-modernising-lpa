...
func (_m *mockDynamoUpdateClient) UpdateReturn(ctx context.Context, pk string, sk string, values map[string]types.AttributeValue, expression string) (map[string]types.AttributeValue, error) {
...
func (_c *mockDynamoUpdateClient_UpdateReturn_Call) Run(run func(ctx context.Context, pk string, sk string, values map[string]types.AttributeValue, expression string)) *mockDynamoUpdateClient_UpdateReturn_Call {
...
func (_c *mockDynamoUpdateClient_UpdateReturn_Call) RunAndReturn(run func(context.Context, string, string, map[string]types.AttributeValue, string) (map[string]types.AttributeValue, error)) *mockDynamoUpdateClient_UpdateReturn_Call {
	_c.Call.Return(run)
	return _c
}
