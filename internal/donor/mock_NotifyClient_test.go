...
// SendActorEmail provides a mock function with given fields: _a0, lang, to, lpaUID, email
func (_m *mockNotifyClient) SendActorEmail(_a0 context.Context, lang localize.Lang, to string, lpaUID string, email notify.Email) error {
	ret := _m.Called(_a0, lang, to, lpaUID, email)
	...
	if rf, ok := ret.Get(0).(func(context.Context, localize.Lang, string, string, notify.Email) error); ok {
		r0 = rf(_a0, lang, to, lpaUID, email)
	} else {
		r0 = ret.Error(0)
	}
...
//   - lpaUID string
//   - email notify.Email
func (_e *mockNotifyClient_Expecter) SendActorEmail(_a0 interface{}, lang interface{}, to interface{}, lpaUID interface{}, email interface{}) *mockNotifyClient_SendActorEmail_Call {
	return &mockNotifyClient_SendActorEmail_Call{Call: _e.mock.On("SendActorEmail", _a0, lang, to, lpaUID, email)}
}

func (_c *mockNotifyClient_SendActorEmail_Call) Run(run func(_a0 context.Context, lang localize.Lang, to string, lpaUID string, email notify.Email)) *mockNotifyClient_SendActorEmail_Call {
...
// SendActorSMS provides a mock function with given fields: _a0, lang, to, lpaUID, sms
func (_m *mockNotifyClient) SendActorSMS(_a0 context.Context, lang localize.Lang, to string, lpaUID string, sms notify.SMS) error {
	ret := _m.Called(_a0, lang, to, lpaUID, sms)
...
//   - lpaUID string
//   - sms notify.SMS
func (_e *mockNotifyClient_Expecter) SendActorSMS(_a0 interface{}, lang interface{}, to interface{}, lpaUID interface{}, sms interface{}) *mockNotifyClient_SendActorSMS_Call {
	return &mockNotifyClient_SendActorSMS_Call{Call: _e.mock.On("SendActorSMS", _a0, lang, to, lpaUID, sms)}
}

func (_c *mockNotifyClient_SendActorSMS_Call) Run(run func(_a0 context.Context, lang localize.Lang, to string, lpaUID string, sms notify.SMS)) *mockNotifyClient_SendActorSMS_Call {
	_c.Call.Run(func(args mock.Arguments) {
