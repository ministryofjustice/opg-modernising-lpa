...
func TestPostCertificateProviderAddressManualWhenSameAddressAsDonor(t *testing.T) {
	f := url.Values{
		form.FieldNames.Address.Action:     {"manual"},
		form.FieldNames.Address.Line1:      {"a"},
		form.FieldNames.Address.Line2:      {"b"},
	...
	err := CertificateProviderAddress(nil, nil, nil, donorStore)(appData, w, r, &donordata.Provided{LpaID: "lpa-id", Donor: donordata.Donor{Address: testAddress}})
	resp := w.Result()
