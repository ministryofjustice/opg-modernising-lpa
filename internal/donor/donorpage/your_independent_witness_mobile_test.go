...
func TestGetYourIndependentWitnessMobile(t *testing.T) {
	...
	err := YourIndependentWitnessMobile(template.Execute, nil)(testAppData, w, r, &donordata.DonorProvidedDetails{})
	resp := w.Result()
...
func TestPostYourIndependentWitnessMobile(t *testing.T) {
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			...
			err := YourIndependentWitnessMobile(nil, donorStore)(testAppData, w, r, &donordata.DonorProvidedDetails{LpaID: "lpa-id"})
			resp := w.Result()
...
func TestPostYourIndependentWitnessMobileWhenStoreErrors(t *testing.T) {
	...
	err := YourIndependentWitnessMobile(nil, donorStore)(testAppData, w, r, &donordata.DonorProvidedDetails{})
