...
func TestGetSignYourLpa(t *testing.T) {
	...
	err := SignYourLpa(template.Execute, nil, testNowFn)(testAppData, w, r, &donordata.DonorProvidedDetails{})
	resp := w.Result()
...
func TestGetSignYourLpaWhenSigned(t *testing.T) {
	...
	err := SignYourLpa(nil, nil, testNowFn)(testAppData, w, r, &donordata.DonorProvidedDetails{
		LpaID:                 "lpa-id",
...
func TestPostSignYourLpa(t *testing.T) {
	...
	err := SignYourLpa(nil, donorStore, testNowFn)(testAppData, w, r, &donordata.DonorProvidedDetails{LpaID: "lpa-id", DonorIdentityUserData: identity.UserData{Status: identity.StatusConfirmed}})
	resp := w.Result()
...
func TestPostSignYourLpaWhenStoreErrors(t *testing.T) {
	...
	err := SignYourLpa(nil, donorStore, testNowFn)(testAppData, w, r, &donordata.DonorProvidedDetails{})
