...
func TestGetPreviousFee(t *testing.T) {
	...
	err := PreviousFee(template.Execute, nil, nil)(testAppData, w, r, &donordata.DonorProvidedDetails{})
	resp := w.Result()
...
func TestGetPreviousFeeFromStore(t *testing.T) {
	...
	err := PreviousFee(template.Execute, nil, nil)(testAppData, w, r, &donordata.DonorProvidedDetails{PreviousFee: pay.PreviousFeeHalf})
	resp := w.Result()
...
func TestPostPreviousFeeWhenFullFee(t *testing.T) {
	...
	err := PreviousFee(nil, payer.Execute, donorStore)(testAppData, w, r, &donordata.DonorProvidedDetails{LpaID: "lpa-id"})
	assert.Nil(t, err)
}
...
func TestPostPreviousFeeWhenOtherFee(t *testing.T) {
	...
	err := PreviousFee(nil, nil, donorStore)(testAppData, w, r, &donordata.DonorProvidedDetails{LpaID: "lpa-id"})
	resp := w.Result()
...
func TestPostPreviousFeeWhenNotChanged(t *testing.T) {
	...
	err := PreviousFee(nil, nil, nil)(testAppData, w, r, &donordata.DonorProvidedDetails{
		LpaID:       "lpa-id",
		PreviousFee: pay.PreviousFeeHalf,
	})
	resp := w.Result()
...
func TestPostPreviousFeeWhenStoreErrors(t *testing.T) {
	...
	err := PreviousFee(nil, nil, donorStore)(testAppData, w, r, &donordata.DonorProvidedDetails{})
