...
func TestGetYourNonUKAddressFromStore(t *testing.T) {
	...
	address := place.InternationalAddress{BuildingNumber: "abc"}
...
func TestGetYourNonUKAddressManual(t *testing.T) {
	w := httptest.NewRecorder()
...
func TestPostYourNonUKAddressManual(t *testing.T) {
	testCases := map[string]struct {
		url              string
...
func TestPostYourNonUKAddressManualWhenAddressNotChanged(t *testing.T) {
	testCases := map[string]struct {
		url              string
		expectedRedirect string
	}{
...
func TestPostYourNonUKAddressManualWhenStoreErrors(t *testing.T) {
	f := url.Values{
		"buildingName": {"x"},
		"town":         {"y"},
	}
...
func TestPostYourNonUKAddressManualWhenValidationError(t *testing.T) {
	f := url.Values{
		"buildingName": {"x"},
	}
