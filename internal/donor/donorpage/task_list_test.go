...
func TestGetTaskList(t *testing.T) {
	testCases := map[string]struct {
		...
		"confirmed identity does not match LPA going to court of protection": {
			...
			expected: func(sections []taskListSection) []taskListSection {
				sections[2].Items[0].Path = donor.PathWhatHappensNextRegisteringWithCourtOfProtection
		...
		"mixed": {
			...
			expected: func(sections []taskListSection) []taskListSection {
				sections[0].Items = []taskListItem{
					...
					{Name: "chooseYourCertificateProvider", Path: donor.PathCertificateProviderDetails, State: task.StateInProgress},
					{Name: "peopleToNotifyAboutYourLpa", Path: donor.PathDoYouWantToNotifyPeople},
					{Name: "addCorrespondent", Path: donor.PathAddCorrespondent},
		...
		"identity confirmation in progress": {
			...
			expected: func(sections []taskListSection) []taskListSection {
				sections[0].Items = []taskListItem{
					...
					{Name: "addRestrictionsToTheLpa", Path: donor.PathRestrictions, State: task.StateCompleted},
					{Name: "chooseYourCertificateProvider", Path: donor.PathCertificateProviderSummary, State: task.StateCompleted},
					{Name: "peopleToNotifyAboutYourLpa", Path: donor.PathDoYouWantToNotifyPeople},
		...
		"witnessed": {
			...
			expected: func(sections []taskListSection) []taskListSection {
				...
				sections[2].Items = []taskListItem{
					{Name: "confirmYourIdentity", Path: donor.PathIdentityDetails, IdentityState: task.IdentityStateCompleted},
					{Name: "signTheLpa", Path: "", State: task.StateCompleted},
				}
