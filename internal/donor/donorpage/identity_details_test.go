...
func TestIdentityDetailsDataState(t *testing.T) {
	testcases := map[string]struct {
		...
		"matched": {
			...
			state: identityDetailsStateMatched,
		},
		"mismatched address": {
			data: &identityDetailsData{
				FirstNamesMatch:  true,
			...
			state: identityDetailsStateAddressNotMatched,
		},
		...
		"mismatched name": {
			...
			state: identityDetailsStateDetailNotMatched,
		},
		...
		"cannot change": {
			...
			state: identityDetailsStateCannotChange,
		},
	}
