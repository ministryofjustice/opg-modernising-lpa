...
func (_m *mockScheduledStore) Put(ctx context.Context, row scheduled.Row) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, scheduled.Row) error); ok {
		r0 = rf(ctx, row)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *mockScheduledStore_Put_Call) Run(run func(ctx context.Context, row scheduled.Row)) *mockScheduledStore_Put_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(scheduled.Row))
	})
	return _c
}
...
func (_c *mockScheduledStore_Put_Call) RunAndReturn(run func(context.Context, scheduled.Row) error) *mockScheduledStore_Put_Call {
	_c.Call.Return(run)
	return _c
}
