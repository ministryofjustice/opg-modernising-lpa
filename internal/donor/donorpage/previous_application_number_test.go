...
func TestGetPreviousApplicationNumber(t *testing.T) {
	...
	err := PreviousApplicationNumber(template.Execute, nil, nil)(testAppData, w, r, &donordata.DonorProvidedDetails{})
	resp := w.Result()
...
func TestGetPreviousApplicationNumberFromStore(t *testing.T) {
	...
	err := PreviousApplicationNumber(template.Execute, nil, nil)(testAppData, w, r, &donordata.DonorProvidedDetails{PreviousApplicationNumber: "ABC"})
	resp := w.Result()
...
func TestPostPreviousApplicationNumber(t *testing.T) {
	...
	for start, redirect := range testcases {
		t.Run(start, func(t *testing.T) {
			...
			err := PreviousApplicationNumber(nil, donorStore, eventClient)(testAppData, w, r, &donordata.DonorProvidedDetails{
				LpaID:  "lpa-id",
				LpaUID: "lpa-uid",
			})
			resp := w.Result()
...
func TestPostPreviousApplicationNumberWhenStoreErrors(t *testing.T) {
	...
	err := PreviousApplicationNumber(nil, donorStore, nil)(testAppData, w, r, &donordata.DonorProvidedDetails{})
	assert.Equal(t, expectedError, err)
}
