...
func (_m *mockShareCodeSender) SendCertificateProviderInvite(ctx context.Context, appData appcontext.Data, provided *donordata.Provided) error {
...
func (_e *mockShareCodeSender_Expecter) SendCertificateProviderInvite(ctx interface{}, appData interface{}, provided interface{}) *mockShareCodeSender_SendCertificateProviderInvite_Call {
	return &mockShareCodeSender_SendCertificateProviderInvite_Call{Call: _e.mock.On("SendCertificateProviderInvite", ctx, appData, provided)}
}

func (_c *mockShareCodeSender_SendCertificateProviderInvite_Call) Run(run func(ctx context.Context, appData appcontext.Data, provided *donordata.Provided)) *mockShareCodeSender_SendCertificateProviderInvite_Call {
...
func (_c *mockShareCodeSender_SendCertificateProviderInvite_Call) RunAndReturn(run func(context.Context, appcontext.Data, *donordata.Provided) error) *mockShareCodeSender_SendCertificateProviderInvite_Call {
	_c.Call.Return(run)
	return _c
}
