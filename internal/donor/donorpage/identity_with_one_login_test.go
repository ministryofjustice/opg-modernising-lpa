...
func TestIdentityWithOneLogin(t *testing.T) {
	...
	err := IdentityWithOneLogin(client, sessionStore, func(int) string { return "i am random" })(page.AppData{Lang: localize.Cy}, w, r, &donordata.DonorProvidedDetails{LpaID: "lpa-id"})
	resp := w.Result()
...
func TestIdentityWithOneLoginWhenAuthCodeURLError(t *testing.T) {
	...
	err := IdentityWithOneLogin(client, nil, func(int) string { return "i am random" })(testAppData, w, r, &donordata.DonorProvidedDetails{})
	resp := w.Result()
...
func TestIdentityWithOneLoginWhenStoreSaveError(t *testing.T) {
	...
	err := IdentityWithOneLogin(client, sessionStore, func(int) string { return "i am random" })(testAppData, w, r, &donordata.DonorProvidedDetails{})
	resp := w.Result()
