...
func Register(
	...
	handleWithDonor(donor.PathWithdrawThisLpa, page.None,
		WithdrawLpa(logger, tmpls.Get("withdraw_this_lpa.gohtml"), donorStore, time.Now, lpaStoreClient, notifyClient, lpaStoreResolvingService, certificateProviderStore, certificateProviderStartURL, attorneyStartURL, eventClient))
