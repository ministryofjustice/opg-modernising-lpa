...
func TestCorrespondentServicePutWhenReuseStoreErrors(t *testing.T) {
	...
	service := &CorrespondentService{reuseStore: reuseStore, newUID: testUIDFn}
	err := service.Put(ctx, &donordata.Provided{
		LpaUID: "lpa-uid",
		Correspondent: donordata.Correspondent{
			FirstNames:  "A",
...
func TestCorrespondentServiceDelete(t *testing.T) {
	correspondent := donordata.Correspondent{FirstNames: "A"}
...
func TestCorrespondentServiceDeleteWhenReuseStoreErrors(t *testing.T) {
	reuseStore := newMockReuseStore(t)
	reuseStore.EXPECT().
		DeleteCorrespondent(mock.Anything, mock.Anything).
		Return(expectedError)
...
func TestCorrespondentServiceDeleteWhenEventClientErrors(t *testing.T) {
	reuseStore := newMockReuseStore(t)
	reuseStore.EXPECT().
		DeleteCorrespondent(mock.Anything, mock.Anything).
		Return(nil)
...
func TestCorrespondentServiceDeleteWhenDonorStoreErrors(t *testing.T) {
	reuseStore := newMockReuseStore(t)
	reuseStore.EXPECT().
		DeleteCorrespondent(mock.Anything, mock.Anything).
		Return(nil)
