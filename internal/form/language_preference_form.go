...
func ReadLanguagePreferenceForm(r *http.Request, errorLabel string) *LanguagePreferenceForm {
	preference, err := localize.ParseLang(PostFormString(r, FieldNames.LanguagePreference.LanguagePreference))
...
func (f *LanguagePreferenceForm) Validate() validation.List {
	...
	errors.Error(FieldNames.LanguagePreference.LanguagePreference, f.ErrorLabel, f.Error,
		validation.Selected())
