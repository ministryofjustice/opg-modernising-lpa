...
func (_m *mockCertificateProviderStore) Create(ctx context.Context, shareCode sharecodedata.Data, email string) (*certificateproviderdata.Provided, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, sharecodedata.Data, string) (*certificateproviderdata.Provided, error)); ok {
		return rf(ctx, shareCode, email)
	}
	if rf, ok := ret.Get(0).(func(context.Context, sharecodedata.Data, string) *certificateproviderdata.Provided); ok {
...
func (_c *mockCertificateProviderStore_Create_Call) Run(run func(ctx context.Context, shareCode sharecodedata.Data, email string)) *mockCertificateProviderStore_Create_Call {
...
func (_c *mockCertificateProviderStore_Create_Call) RunAndReturn(run func(context.Context, sharecodedata.Data, string) (*certificateproviderdata.Provided, error)) *mockCertificateProviderStore_Create_Call {
	_c.Call.Return(run)
	return _c
}
