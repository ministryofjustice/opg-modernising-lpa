...
func (_m *mockCertificateProviderStore) Create(ctx context.Context, link accesscodedata.Link, email string) (*certificateproviderdata.Provided, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, accesscodedata.Link, string) (*certificateproviderdata.Provided, error)); ok {
		return rf(ctx, link, email)
	}
	if rf, ok := ret.Get(0).(func(context.Context, accesscodedata.Link, string) *certificateproviderdata.Provided); ok {
...
//   - email string
func (_e *mockCertificateProviderStore_Expecter) Create(ctx interface{}, link interface{}, email interface{}) *mockCertificateProviderStore_Create_Call {
	return &mockCertificateProviderStore_Create_Call{Call: _e.mock.On("Create", ctx, link, email)}
}

func (_c *mockCertificateProviderStore_Create_Call) Run(run func(ctx context.Context, link accesscodedata.Link, email string)) *mockCertificateProviderStore_Create_Call {
...
func (_c *mockCertificateProviderStore_Create_Call) RunAndReturn(run func(context.Context, accesscodedata.Link, string) (*certificateproviderdata.Provided, error)) *mockCertificateProviderStore_Create_Call {
	_c.Call.Return(run)
	return _c
}
