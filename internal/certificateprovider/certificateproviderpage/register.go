...
func Register(
	...
	handleRoot(page.PathCertificateProviderEnterReferenceNumber, page.None,
		EnterReferenceNumber(tmpls.Get("enter_reference_number.gohtml"), shareCodeStore, sessionStore, certificateProviderStore, lpaStoreClient))
	handleRoot(page.PathCertificateProviderEnterReferenceNumberLoggedIn, page.RequireSession,
		EnterReferenceNumber(tmpls.Get("enter_reference_number.gohtml"), shareCodeStore, sessionStore, certificateProviderStore, lpaStoreClient))
