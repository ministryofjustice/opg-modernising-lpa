...
func (_m *mockShareCodeStore) Delete(ctx context.Context, shareCode sharecode.Data) error {
...
func (_c *mockShareCodeStore_Delete_Call) Run(run func(ctx context.Context, shareCode sharecode.Data)) *mockShareCodeStore_Delete_Call {
...
func (_m *mockShareCodeStore) Get(ctx context.Context, actorType actor.Type, shareCode string) (sharecode.Data, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, actor.Type, string) (sharecode.Data, error)); ok {
		return rf(ctx, actorType, shareCode)
	}
	if rf, ok := ret.Get(0).(func(context.Context, actor.Type, string) sharecode.Data); ok {
...
func (_c *mockShareCodeStore_Get_Call) RunAndReturn(run func(context.Context, actor.Type, string) (sharecode.Data, error)) *mockShareCodeStore_Get_Call {
	_c.Call.Return(run)
	return _c
}

// Put provides a mock function with given fields: ctx, actorType, shareCode, shareCodeData
func (_m *mockShareCodeStore) Put(ctx context.Context, actorType actor.Type, shareCode string, shareCodeData sharecode.Data) error {
	ret := _m.Called(ctx, actorType, shareCode, shareCodeData)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, actor.Type, string, sharecode.Data) error); ok {
		r0 = rf(ctx, actorType, shareCode, shareCodeData)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *mockShareCodeStore_Expecter) Put(ctx interface{}, actorType interface{}, shareCode interface{}, shareCodeData interface{}) *mockShareCodeStore_Put_Call {
	return &mockShareCodeStore_Put_Call{Call: _e.mock.On("Put", ctx, actorType, shareCode, shareCodeData)}
}

func (_c *mockShareCodeStore_Put_Call) Run(run func(ctx context.Context, actorType actor.Type, shareCode string, shareCodeData sharecode.Data)) *mockShareCodeStore_Put_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(actor.Type), args[2].(string), args[3].(sharecode.Data))
	})
	return _c
}
...
func (_c *mockShareCodeStore_Put_Call) RunAndReturn(run func(context.Context, actor.Type, string, sharecode.Data) error) *mockShareCodeStore_Put_Call {
	_c.Call.Return(run)
	return _c
}
