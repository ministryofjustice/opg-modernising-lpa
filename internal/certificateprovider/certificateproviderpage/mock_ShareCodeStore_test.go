...
func (_m *mockShareCodeStore) Delete(ctx context.Context, shareCode sharecodedata.Data) error {
...
func (_c *mockShareCodeStore_Delete_Call) Run(run func(ctx context.Context, shareCode sharecodedata.Data)) *mockShareCodeStore_Delete_Call {
...
func (_m *mockShareCodeStore) Put(ctx context.Context, actorType actor.Type, shareCode string, shareCodeData sharecodedata.Data) error {
...
func (_c *mockShareCodeStore_Put_Call) Run(run func(ctx context.Context, actorType actor.Type, shareCode string, shareCodeData sharecodedata.Data)) *mockShareCodeStore_Put_Call {
	_c.Call.Run(func(args mock.Arguments) {
