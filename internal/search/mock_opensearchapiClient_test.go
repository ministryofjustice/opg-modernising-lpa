...
func (_m *mockOpensearchapiClient) Info(ctx context.Context, req *opensearchapi.InfoReq) (*opensearchapi.InfoResp, error) {
	ret := _m.Called(ctx, req)
	...
	var r0 *opensearchapi.InfoResp
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *opensearchapi.InfoReq) (*opensearchapi.InfoResp, error)); ok {
		return rf(ctx, req)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *opensearchapi.InfoReq) *opensearchapi.InfoResp); ok {
		r0 = rf(ctx, req)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*opensearchapi.InfoResp)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *opensearchapi.InfoReq) error); ok {
		r1 = rf(ctx, req)
	} else {
		r1 = ret.Error(1)
	}
...
// mockOpensearchapiClient_Info_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Info'
type mockOpensearchapiClient_Info_Call struct {
	*mock.Call
}
...
func (_e *mockOpensearchapiClient_Expecter) Info(ctx interface{}, req interface{}) *mockOpensearchapiClient_Info_Call {
	return &mockOpensearchapiClient_Info_Call{Call: _e.mock.On("Info", ctx, req)}
}

func (_c *mockOpensearchapiClient_Info_Call) Run(run func(ctx context.Context, req *opensearchapi.InfoReq)) *mockOpensearchapiClient_Info_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*opensearchapi.InfoReq))
	})
	return _c
}

func (_c *mockOpensearchapiClient_Info_Call) Return(_a0 *opensearchapi.InfoResp, _a1 error) *mockOpensearchapiClient_Info_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockOpensearchapiClient_Info_Call) RunAndReturn(run func(context.Context, *opensearchapi.InfoReq) (*opensearchapi.InfoResp, error)) *mockOpensearchapiClient_Info_Call {
	_c.Call.Return(run)
	return _c
}
