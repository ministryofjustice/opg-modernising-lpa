...
test('replacement attorney property and affairs', async ({ page }) => {
    ...
    await page.goto(`/fixtures/attorney?redirect=&lpa-type=property-and-affairs&lpa-language=en&progress=signedByCertificateProvider&withAccessCode=${accessCode}&email=${TestEmail}&options=is-replacement`);
