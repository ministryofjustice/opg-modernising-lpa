...
test('replacement attorney personal welfare', async ({ page }) => {
  ...
  await page.goto(`/fixtures/attorney?redirect=&lpa-type=personal-welfare&lpa-language=en&progress=signedByCertificateProvider&withShareCode=${shareCode}&email=${TestEmail}&options=is-replacement`);
