...
import {screenshot, randomShareCode, TestEmail} from '../../../test/playwright/e2e.js'
...
test('trust corporation wants to be an attorney', async ({ page }) => {
  ...
  await page.goto(`/fixtures/attorney?redirect=&lpa-type=property-and-affairs&lpa-language=en&progress=signedByCertificateProvider&withShareCode=${shareCode}&email=${TestEmail}&options=is-trust-corporation`);
